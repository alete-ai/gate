...
| [004-transfer-learning-classifier](./tracks/004-transfer-learning-classifier/index.md) | Transfer Learning Classifier | `New` | Upgrading the edge classifier (PrivacyGatekeeper) to use Create ML transfer learning with OS-provided embeddings. |
